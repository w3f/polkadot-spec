...
for stem:["Auth"_C(B_0)] is set in the genesis state (TODO
<<sect-genesis-block>>) and can be retrieved using a runtime entry corresponding
to consensus engine stem:[C].
