...
*  stem:[P_h] is the parachain parent head data (<<defn-para-head-data>>).
*  stem:[d] is a dispute statement (<<sect-anv-disputes>>).
...
* stem:[p_h] is the hash of the parachain head data (<<defn-para-head-data>>) of this candidate.
...
* stem:[h] is the parachain head data (<<defn-para-head-data>>).
