...
\begin{definition}
  ...
  {\center{\tmfloat{h}{small}{table}{\begin{tabular}{l|l|l}
    ...
    \hline
    1 & Scheduled Change & $(\tmop{Auth}_C, N_B)$\\
    2 & [RESERVED] & [RESERVED]\\
  ...
  GRANDPA authorities}}}
  Where Auth$_C$ is defined in Definition \ref{defn-authority-list}, $N_B$ is
  the number of blocks to delay the change. $\tmop{Auth}_{\tmop{ID}}$ is a 64
  bit integer pointing to the authority list of the current block. Type Id 2
  is reserved for future development {\todo{Spec Force Change}}.
\end{definition}
...
2$)\textbar\textbar$n$\textbar\textbar$\rho$)}}}}}}
...
\text{\tmverbatim{Core\_initialize\_block}}, \tmop{Head} (_{} B) \right)$}}

{\state{{\tmname{Call-Runtime-Entry}}$\left(
\text{\tmverbatim{BlockBuilder\_inherent\_extrinsics}},
\text{{\tmname{Inherent-Data}}} \right)${\END}}}

{\state{{\WHILE{{\tmstrong{not}} {\tmname{End-Of-Slot(s)}}}}}}

{\state{$E \leftarrow${\tmname{Next-Ready-Extrinsic()}}}}

{\state{$R
\leftarrow${\tmname{Call-Runtime-Entry(}}\tmverbatim{BlockBuilder\_apply\_extrinsics},
{\tmem{E}})}}

{\state{{\IF{{\tmstrong{not}} {\tmname{Block-Is-FULL($R$}})}}}}

{\state{{\tmname{Drop(Ready-Extrinsics-Queue}}, {\tmem{E}}){\END}}}
...
{\state{$\tmop{Head} (B)
\leftarrow${\tmname{Call-Runtime-Entry(}}\tmverbatim{BlockBuilder\_finalize\_block},
{\tmem{B}})}}}}
...
\tmfloat{h}{small}{table}{\begin{tabular}{lll}
  \hline
  {\tmstrong{Type Index}} & {\tmstrong{Data type}} &
  {\tmstrong{Descri{\tmstrong{}}ption}}\\
  \hline
