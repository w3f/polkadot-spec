...
\subsection{\tmverbatim{ext\_storage\_changes\_root}}

Commits all existing operations and gets the resulting change root. The parent
hash is a SCALE encoded change root.
...
\begin{itemize}
  ...
  \item \tmverbatim{return}: a pointer-size as defined in Definition
  \ref{defn-runtime-pointer} indicating the SCALE encoded \tmverbatim{Option}
  as defined in Definition \ref{defn-option-type} containing the change root.
\end{itemize}
...
\subsection{\tmverbatim{ext\_storage\_child\_root}}
