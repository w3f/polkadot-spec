...
<\body>
  ...
  storage then `null` will be returned.
  ...
  <\itemize>
    ...
    \<#2018\>null\<#2018\> if the value does not exist.
  </itemize>
  ...
  request statuses (the size is the same as amount of IDs). Passing `null` as
  ...
  fully consumed and the `request_id` is now invalid. This implies that
