...
<\body>
  ...
  <\table-of-contents|toc>
    ...
    <with|par-left|1tab|A.5.1.<space|2spc>Creating a Controller key
    <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
    <no-break><pageref|auto-93>>

    <with|par-left|1tab|A.5.2.<space|2spc>Designating a proxy for voting
    <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
    <no-break><pageref|auto-94>>

    <with|par-left|1tab|A.5.3.<space|2spc>Certifying keys
    <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
  ...
  has it's own unique function and must be treated differently, as described
  by this section.
  ...
  <\definition>
    <label|defn-stash-key><em|<strong|Stash key> is a type of an account key
    which holds funds bonded for staking \ (described in
    <reference|desc-staking-funds>) to a particular Controller key (definied
    in <reference|defn-controller-key>). As a result, one may actively
    participate with a Stash key while it can kept offline in a secure
    location. It can also be used to designate a Proxy account to vote in
    governance proposals, as described in
  ...
  <\definition>
    <em|<label|defn-controller-key><strong|Controller key> This account key
    acts on behalf of the Stash account. It signs transactions which make
    decisions about nominating and validating. It's a key that will be in the
    direct control of a user and should mostly be kept offline, used to
    submit manual extrinsics. It sets preferences like payout account and
    commission, as described in <reference|desc-controller-settings>. If used
    for a validator, it also sets the session keys, as described in
  ...
  as defined in <reference|desc-creating-controller-key> respectively
  <reference|desc-certifying-keys>.

  <\definition>
    <em|<strong|Session keys> are short lived keys which are used to
    authenticate validator operations. Session keys are generated by Polkadot
    RE and should be changed regularly due to security reasons. Nonetheless
    no validity period is enforced by Polkadot protocol on session keys.
    Various types of key used by Polkadot RE are presented in Table
  ...
  <label|desc-staking-funds>TODO

  <subsection|Creating a Controller key>

  <label|desc-creating-controller-key>TODO

  <subsection|Designating a proxy for voting>

  <label|desc-designating-proxy>TODO<math|>

  <subsection|Controller settings>

  <label|desc-controller-settings>TODO<math|>
  ...
  <todo|could you spec the detail of the data structure of the certificate
...
<\references>
  <\collection>
    <associate|alg-join-leave-grandpa|<tuple|5.8|37|polkadot_re_spec.tm~>>
    <associate|algo-aggregate-key|<tuple|2.1|13|polkadot_re_spec.tm~>>
    <associate|algo-attempt-to\Ufinalize|<tuple|5.11|38|polkadot_re_spec.tm~>>
    <associate|algo-block-production|<tuple|5.3|32|polkadot_re_spec.tm~>>
    <associate|algo-block-production-lottery|<tuple|5.1|30|polkadot_re_spec.tm~>>
    <associate|algo-build-block|<tuple|5.7|34|polkadot_re_spec.tm~>>
    <associate|algo-epoch-randomness|<tuple|5.4|32|polkadot_re_spec.tm~>>
    <associate|algo-grandpa-best-candidate|<tuple|5.10|38|polkadot_re_spec.tm~>>
    <associate|algo-grandpa-round|<tuple|5.9|37|polkadot_re_spec.tm~>>
    <associate|algo-maintain-transaction-pool|<tuple|3.3|20|polkadot_re_spec.tm~>>
    <associate|algo-pk-length|<tuple|2.2|14|polkadot_re_spec.tm~>>
    <associate|algo-runtime-interaction|<tuple|3.1|17|polkadot_re_spec.tm~>>
    <associate|algo-slot-time|<tuple|5.2|31|polkadot_re_spec.tm~>>
    <associate|algo-validate-transactions|<tuple|3.2|20|polkadot_re_spec.tm~>>
    <associate|algo-verify-authorship-right|<tuple|5.5|33|polkadot_re_spec.tm~>>
    <associate|algo-verify-slot-winner|<tuple|5.6|33|polkadot_re_spec.tm~>>
    <associate|auto-1|<tuple|1|7|polkadot_re_spec.tm~>>
    <associate|auto-10|<tuple|1.9|9|polkadot_re_spec.tm~>>
    <associate|auto-100|<tuple|B.1.1|47|polkadot_re_spec.tm~>>
    <associate|auto-101|<tuple|B.2|49|polkadot_re_spec.tm~>>
    <associate|auto-102|<tuple|B.2.1|49|polkadot_re_spec.tm~>>
    <associate|auto-103|<tuple|B.2.2|49|polkadot_re_spec.tm~>>
    <associate|auto-104|<tuple|B.3|49|polkadot_re_spec.tm~>>
    <associate|auto-105|<tuple|C|50|polkadot_re_spec.tm~>>
    <associate|auto-106|<tuple|D|50|polkadot_re_spec.tm~>>
    <associate|auto-107|<tuple|E|50|polkadot_re_spec.tm~>>
    <associate|auto-108|<tuple|E.1|51|polkadot_re_spec.tm~>>
    <associate|auto-109|<tuple|E.1|51|polkadot_re_spec.tm~>>
    <associate|auto-11|<tuple|1.9|9|polkadot_re_spec.tm~>>
    <associate|auto-110|<tuple|E.1.1|51|polkadot_re_spec.tm~>>
    <associate|auto-111|<tuple|E.2|52|polkadot_re_spec.tm~>>
    <associate|auto-112|<tuple|E.1.2|53|polkadot_re_spec.tm~>>
    <associate|auto-113|<tuple|E.3|53|polkadot_re_spec.tm~>>
    <associate|auto-114|<tuple|E.1.3|53|polkadot_re_spec.tm~>>
    <associate|auto-115|<tuple|E.1.4|53|polkadot_re_spec.tm~>>
    <associate|auto-116|<tuple|E.1.5|54|polkadot_re_spec.tm~>>
    <associate|auto-117|<tuple|E.1.6|54|polkadot_re_spec.tm~>>
    <associate|auto-118|<tuple|F|54|polkadot_re_spec.tm~>>
    <associate|auto-119|<tuple|F.1|54|polkadot_re_spec.tm~>>
    <associate|auto-12|<tuple|1.9|9|polkadot_re_spec.tm~>>
    <associate|auto-120|<tuple|F.1.1|55|polkadot_re_spec.tm~>>
    <associate|auto-121|<tuple|F.1.2|55|polkadot_re_spec.tm~>>
    <associate|auto-122|<tuple|F.1.2.1|56|polkadot_re_spec.tm~>>
    <associate|auto-123|<tuple|F.1.3|56|polkadot_re_spec.tm~>>
    <associate|auto-124|<tuple|F.1.4|56|polkadot_re_spec.tm~>>
    <associate|auto-125|<tuple|F.1.4.1|56|polkadot_re_spec.tm~>>
    <associate|auto-126|<tuple|F.1.5|57|polkadot_re_spec.tm~>>
    <associate|auto-127|<tuple|F.1.6|57|polkadot_re_spec.tm~>>
    <associate|auto-128|<tuple|F.1.7|57|polkadot_re_spec.tm~>>
    <associate|auto-129|<tuple|F.1.8|57|polkadot_re_spec.tm~>>
    <associate|auto-13|<tuple|1.9|9|polkadot_re_spec.tm~>>
    <associate|auto-130|<tuple|F.1.8.1|57|polkadot_re_spec.tm~>>
    <associate|auto-131|<tuple|F.1.8.2|58|polkadot_re_spec.tm~>>
    <associate|auto-132|<tuple|F.1.8.3|58|polkadot_re_spec.tm~>>
    <associate|auto-133|<tuple|F.1.9|59|polkadot_re_spec.tm~>>
    <associate|auto-134|<tuple|F.1.9.1|59|polkadot_re_spec.tm~>>
    <associate|auto-135|<tuple|F.1.9.2|59|polkadot_re_spec.tm~>>
    <associate|auto-136|<tuple|F.1.9.3|60|polkadot_re_spec.tm~>>
    <associate|auto-137|<tuple|F.1.9.4|60|polkadot_re_spec.tm~>>
    <associate|auto-138|<tuple|F.1.9.5|60|polkadot_re_spec.tm~>>
    <associate|auto-139|<tuple|F.1.9.6|61|polkadot_re_spec.tm~>>
    <associate|auto-14|<tuple|1.2.1|9|polkadot_re_spec.tm~>>
    <associate|auto-140|<tuple|F.1.10|61|polkadot_re_spec.tm~>>
    <associate|auto-141|<tuple|F.1.10.1|61|polkadot_re_spec.tm~>>
    <associate|auto-142|<tuple|F.1.10.2|62|polkadot_re_spec.tm~>>
    <associate|auto-143|<tuple|F.1.10.3|62|polkadot_re_spec.tm~>>
    <associate|auto-144|<tuple|F.1.10.4|62|polkadot_re_spec.tm~>>
    <associate|auto-145|<tuple|F.1.10.5|63|polkadot_re_spec.tm~>>
    <associate|auto-146|<tuple|F.1.10.6|63|polkadot_re_spec.tm~>>
    <associate|auto-147|<tuple|F.1.10.7|64|polkadot_re_spec.tm~>>
    <associate|auto-148|<tuple|F.1.10.8|64|polkadot_re_spec.tm~>>
    <associate|auto-149|<tuple|F.1.10.9|65|polkadot_re_spec.tm~>>
    <associate|auto-15|<tuple|1.11|9|polkadot_re_spec.tm~>>
    <associate|auto-150|<tuple|F.1.10.10|65|polkadot_re_spec.tm~>>
    <associate|auto-151|<tuple|F.1.10.11|65|polkadot_re_spec.tm~>>
    <associate|auto-152|<tuple|F.1.10.12|65|polkadot_re_spec.tm~>>
    <associate|auto-153|<tuple|F.1.10.13|65|polkadot_re_spec.tm~>>
    <associate|auto-154|<tuple|F.1.10.14|66|polkadot_re_spec.tm~>>
    <associate|auto-155|<tuple|F.1.10.15|66|polkadot_re_spec.tm~>>
    <associate|auto-156|<tuple|F.1.11|66|polkadot_re_spec.tm~>>
    <associate|auto-157|<tuple|F.1.11.1|66|polkadot_re_spec.tm~>>
    <associate|auto-158|<tuple|F.1.12|66|polkadot_re_spec.tm~>>
    <associate|auto-159|<tuple|F.1.12.1|67|polkadot_re_spec.tm~>>
    <associate|auto-16|<tuple|1.12|9|polkadot_re_spec.tm~>>
    <associate|auto-160|<tuple|F.1.12.2|67|polkadot_re_spec.tm~>>
    <associate|auto-161|<tuple|F.1.13|67|polkadot_re_spec.tm~>>
    <associate|auto-162|<tuple|F.1.13.1|68|polkadot_re_spec.tm~>>
    <associate|auto-163|<tuple|F.1.14|68|polkadot_re_spec.tm~>>
    <associate|auto-164|<tuple|F.2|68|polkadot_re_spec.tm~>>
    <associate|auto-165|<tuple|G|68|polkadot_re_spec.tm~>>
    <associate|auto-166|<tuple|G.1|68|polkadot_re_spec.tm~>>
    <associate|auto-167|<tuple|G.1|68|polkadot_re_spec.tm~>>
    <associate|auto-168|<tuple|G.2|69|polkadot_re_spec.tm~>>
    <associate|auto-169|<tuple|G.2.1|69|polkadot_re_spec.tm~>>
    <associate|auto-17|<tuple|1.12|9|polkadot_re_spec.tm~>>
    <associate|auto-170|<tuple|G.1|69|polkadot_re_spec.tm~>>
    <associate|auto-171|<tuple|G.2.2|70|polkadot_re_spec.tm~>>
    <associate|auto-172|<tuple|G.2.3|70|polkadot_re_spec.tm~>>
    <associate|auto-173|<tuple|G.2.4|71|polkadot_re_spec.tm~>>
    <associate|auto-174|<tuple|G.2.5|73|polkadot_re_spec.tm~>>
    <associate|auto-175|<tuple|G.2.6|75|polkadot_re_spec.tm~>>
    <associate|auto-176|<tuple|G.2.7|?|polkadot_re_spec.tm~>>
    <associate|auto-177|<tuple|G.2|?|polkadot_re_spec.tm~>>
    <associate|auto-178|<tuple|G.3|?|polkadot_re_spec.tm~>>
    <associate|auto-179|<tuple|G.3|?|polkadot_re_spec.tm~>>
    <associate|auto-18|<tuple|1.13|9|polkadot_re_spec.tm~>>
    <associate|auto-180|<tuple|G.3|?|polkadot_re_spec.tm~>>
    <associate|auto-181|<tuple|Tec19|?|polkadot_re_spec.tm~>>
    <associate|auto-19|<tuple|1.13|9|polkadot_re_spec.tm~>>
    <associate|auto-2|<tuple|1.1|7|polkadot_re_spec.tm~>>
    <associate|auto-20|<tuple|1.13|9|polkadot_re_spec.tm~>>
    <associate|auto-21|<tuple|1.13|9|polkadot_re_spec.tm~>>
    <associate|auto-22|<tuple|1.13|9|polkadot_re_spec.tm~>>
    <associate|auto-23|<tuple|1.13|9|polkadot_re_spec.tm~>>
    <associate|auto-24|<tuple|1.13|9|polkadot_re_spec.tm~>>
    <associate|auto-25|<tuple|1.14|9|polkadot_re_spec.tm~>>
    <associate|auto-26|<tuple|1.15|9|polkadot_re_spec.tm~>>
    <associate|auto-27|<tuple|1.15|9|polkadot_re_spec.tm~>>
    <associate|auto-28|<tuple|2|11|polkadot_re_spec.tm~>>
    <associate|auto-29|<tuple|2.1|11|polkadot_re_spec.tm~>>
    <associate|auto-3|<tuple|1.2|7|polkadot_re_spec.tm~>>
    <associate|auto-30|<tuple|2.1.1|11|polkadot_re_spec.tm~>>
    <associate|auto-31|<tuple|2.1|11|polkadot_re_spec.tm~>>
    <associate|auto-32|<tuple|2.1.2|11|polkadot_re_spec.tm~>>
    <associate|auto-33|<tuple|2.1.3|12|polkadot_re_spec.tm~>>
    <associate|auto-34|<tuple|2.1.4|14|polkadot_re_spec.tm~>>
    <associate|auto-35|<tuple|3|17|polkadot_re_spec.tm~>>
    <associate|auto-36|<tuple|3.1|17|polkadot_re_spec.tm~>>
    <associate|auto-37|<tuple|3.1.1|17|polkadot_re_spec.tm~>>
    <associate|auto-38|<tuple|3.1.2|18|polkadot_re_spec.tm~>>
    <associate|auto-39|<tuple|3.1.2.1|18|polkadot_re_spec.tm~>>
    <associate|auto-4|<tuple|1.2|8|polkadot_re_spec.tm~>>
    <associate|auto-40|<tuple|3.1.2.2|18|polkadot_re_spec.tm~>>
    <associate|auto-41|<tuple|3.1.2.3|19|polkadot_re_spec.tm~>>
    <associate|auto-42|<tuple|3.2|19|polkadot_re_spec.tm~>>
    <associate|auto-43|<tuple|3.2.1|19|polkadot_re_spec.tm~>>
    <associate|auto-44|<tuple|3.2.2|19|polkadot_re_spec.tm~>>
    <associate|auto-45|<tuple|3.2.2.1|19|polkadot_re_spec.tm~>>
    <associate|auto-46|<tuple|3.2.3|19|polkadot_re_spec.tm~>>
    <associate|auto-47|<tuple|3.2.3|19|polkadot_re_spec.tm~>>
    <associate|auto-48|<tuple|3.2.3|19|polkadot_re_spec.tm~>>
    <associate|auto-49|<tuple|3.2.3|19|polkadot_re_spec.tm~>>
    <associate|auto-5|<tuple|1.4|8|polkadot_re_spec.tm~>>
    <associate|auto-50|<tuple|<with|mode|<quote|math>|<rigid|->>|20|polkadot_re_spec.tm~>>
    <associate|auto-51|<tuple|3.2.3.1|20|polkadot_re_spec.tm~>>
    <associate|auto-52|<tuple|3.1|21|polkadot_re_spec.tm~>>
    <associate|auto-53|<tuple|3.3|21|polkadot_re_spec.tm~>>
    <associate|auto-54|<tuple|3.3.1|21|polkadot_re_spec.tm~>>
    <associate|auto-55|<tuple|3.3.1.1|21|polkadot_re_spec.tm~>>
    <associate|auto-56|<tuple|3.2|22|polkadot_re_spec.tm~>>
    <associate|auto-57|<tuple|3.3.1.2|22|polkadot_re_spec.tm~>>
    <associate|auto-58|<tuple|3.3.1.3|22|polkadot_re_spec.tm~>>
    <associate|auto-59|<tuple|3.3.2|23|polkadot_re_spec.tm~>>
    <associate|auto-6|<tuple|1.7|8|polkadot_re_spec.tm~>>
    <associate|auto-60|<tuple|3.3.3|23|polkadot_re_spec.tm~>>
    <associate|auto-61|<tuple|4|25|polkadot_re_spec.tm~>>
    <associate|auto-62|<tuple|4.1|25|polkadot_re_spec.tm~>>
    <associate|auto-63|<tuple|4.2|25|polkadot_re_spec.tm~>>
    <associate|auto-64|<tuple|4.3|26|polkadot_re_spec.tm~>>
    <associate|auto-65|<tuple|4.3.1|26|polkadot_re_spec.tm~>>
    <associate|auto-66|<tuple|4.3.2|26|polkadot_re_spec.tm~>>
    <associate|auto-67|<tuple|4.4|26|polkadot_re_spec.tm~>>
    <associate|auto-68|<tuple|4.4.1|27|polkadot_re_spec.tm~>>
    <associate|auto-69|<tuple|4.4.2|27|polkadot_re_spec.tm~>>
    <associate|auto-7|<tuple|1.7|8|polkadot_re_spec.tm~>>
    <associate|auto-70|<tuple|5|29|polkadot_re_spec.tm~>>
    <associate|auto-71|<tuple|5.1|29|polkadot_re_spec.tm~>>
    <associate|auto-72|<tuple|5.1.1|29|polkadot_re_spec.tm~>>
    <associate|auto-73|<tuple|5.1.2|30|polkadot_re_spec.tm~>>
    <associate|auto-74|<tuple|5.1.3|30|polkadot_re_spec.tm~>>
    <associate|auto-75|<tuple|5.1.4|31|polkadot_re_spec.tm~>>
    <associate|auto-76|<tuple|5.1.5|32|polkadot_re_spec.tm~>>
    <associate|auto-77|<tuple|5.1.6|32|polkadot_re_spec.tm~>>
    <associate|auto-78|<tuple|5.1.7|33|polkadot_re_spec.tm~>>
    <associate|auto-79|<tuple|5.2|34|polkadot_re_spec.tm~>>
    <associate|auto-8|<tuple|1.7|8|polkadot_re_spec.tm~>>
    <associate|auto-80|<tuple|5.2.1|34|polkadot_re_spec.tm~>>
    <associate|auto-81|<tuple|5.2.2|36|polkadot_re_spec.tm~>>
    <associate|auto-82|<tuple|5.2.3|37|polkadot_re_spec.tm~>>
    <associate|auto-83|<tuple|5.2.4|37|polkadot_re_spec.tm~>>
    <associate|auto-84|<tuple|5.3|38|polkadot_re_spec.tm~>>
    <associate|auto-85|<tuple|A|39|polkadot_re_spec.tm~>>
    <associate|auto-86|<tuple|A.1|39|polkadot_re_spec.tm~>>
    <associate|auto-87|<tuple|A.2|39|polkadot_re_spec.tm~>>
    <associate|auto-88|<tuple|A.3|39|polkadot_re_spec.tm~>>
    <associate|auto-89|<tuple|A.4|39|polkadot_re_spec.tm~>>
    <associate|auto-9|<tuple|1.9|9|polkadot_re_spec.tm~>>
    <associate|auto-90|<tuple|A.5|39|polkadot_re_spec.tm~>>
    <associate|auto-91|<tuple|A.1|39|polkadot_re_spec.tm~>>
    <associate|auto-92|<tuple|A.2|?|polkadot_re_spec.tm~>>
    <associate|auto-93|<tuple|A.5.1|41|polkadot_re_spec.tm~>>
    <associate|auto-94|<tuple|A.5.2|42|polkadot_re_spec.tm~>>
    <associate|auto-95|<tuple|A.5.3|43|polkadot_re_spec.tm~>>
    <associate|auto-96|<tuple|A.5.4|43|polkadot_re_spec.tm~>>
    <associate|auto-97|<tuple|A.5.5|43|polkadot_re_spec.tm~>>
    <associate|auto-98|<tuple|B|43|polkadot_re_spec.tm~>>
    <associate|auto-99|<tuple|B.1|45|polkadot_re_spec.tm~>>
    <associate|bib-collet_extremely_2019|<tuple|Col19|73|polkadot_re_spec.tm~>>
    <associate|bib-david_ouroboros_2018|<tuple|DGKR18|73|polkadot_re_spec.tm~>>
    <associate|bib-liusvaara_edwards-curve_2017|<tuple|LJ17|73|polkadot_re_spec.tm~>>
    <associate|bib-parity_technologies_substrate_2019|<tuple|Tec19|73|polkadot_re_spec.tm~>>
    <associate|bib-perrin_noise_2018|<tuple|Per18|73|polkadot_re_spec.tm~>>
    <associate|bib-protocol_labs_libp2p_2019|<tuple|lab19|73|polkadot_re_spec.tm~>>
    <associate|bib-saarinen_blake2_2015|<tuple|SA15|73|polkadot_re_spec.tm~>>
    <associate|bib-stewart_grandpa:_2019|<tuple|Ste19|73|polkadot_re_spec.tm~>>
    <associate|bib-w3f_research_group_blind_2019|<tuple|Gro19|73|polkadot_re_spec.tm~>>
    <associate|block|<tuple|3.3.1.1|21|polkadot_re_spec.tm~>>
    <associate|chap-consensu|<tuple|5|29|polkadot_re_spec.tm~>>
    <associate|chap-state-spec|<tuple|2|11|polkadot_re_spec.tm~>>
    <associate|chap-state-transit|<tuple|3|17|polkadot_re_spec.tm~>>
    <associate|defn-account-key|<tuple|A.1|39|polkadot_re_spec.tm~>>
    <associate|defn-babe-header|<tuple|5.10|31|polkadot_re_spec.tm~>>
    <associate|defn-babe-seal|<tuple|5.11|31|polkadot_re_spec.tm~>>
    <associate|defn-bit-rep|<tuple|1.6|8|polkadot_re_spec.tm~>>
    <associate|defn-block-body|<tuple|3.9|22|polkadot_re_spec.tm~>>
    <associate|defn-block-data|<tuple|E.2|51|polkadot_re_spec.tm~>>
    <associate|defn-block-header|<tuple|3.6|21|polkadot_re_spec.tm~>>
    <associate|defn-block-header-hash|<tuple|3.8|22|polkadot_re_spec.tm~>>
    <associate|defn-block-signature|<tuple|5.11|31|polkadot_re_spec.tm~>>
    <associate|defn-block-time|<tuple|5.8|30|polkadot_re_spec.tm~>>
    <associate|defn-block-tree|<tuple|1.11|9|polkadot_re_spec.tm~>>
    <associate|defn-chain-subchain|<tuple|1.13|9|polkadot_re_spec.tm~>>
    <associate|defn-children-bitmap|<tuple|2.10|15|polkadot_re_spec.tm~>>
    <associate|defn-controller-key|<tuple|A.3|?|polkadot_re_spec.tm~>>
    <associate|defn-digest|<tuple|3.7|21|polkadot_re_spec.tm~>>
    <associate|defn-epoch-slot|<tuple|5.3|29|polkadot_re_spec.tm~>>
    <associate|defn-epoch-subchain|<tuple|5.5|30|polkadot_re_spec.tm~>>
    <associate|defn-finalized-block|<tuple|5.25|38|polkadot_re_spec.tm~>>
    <associate|defn-func-inherent-data|<tuple|3.5|21|polkadot_re_spec.tm~>>
    <associate|defn-grandpa-completable|<tuple|5.21|36|polkadot_re_spec.tm~>>
    <associate|defn-grandpa-justification|<tuple|5.23|36|polkadot_re_spec.tm~>>
    <associate|defn-hex-encoding|<tuple|B.9|43|polkadot_re_spec.tm~>>
    <associate|defn-http-return-value|<tuple|F.4|59|polkadot_re_spec.tm~>>
    <associate|defn-index-function|<tuple|2.7|13|polkadot_re_spec.tm~>>
    <associate|defn-little-endian|<tuple|1.7|8|polkadot_re_spec.tm~>>
    <associate|defn-longest-chain|<tuple|1.14|9|polkadot_re_spec.tm~>>
    <associate|defn-merkle-value|<tuple|2.12|15|polkadot_re_spec.tm~>>
    <associate|defn-node-header|<tuple|2.9|13|polkadot_re_spec.tm~>>
    <associate|defn-node-key|<tuple|2.6|13|polkadot_re_spec.tm~>>
    <associate|defn-node-subvalue|<tuple|2.11|15|polkadot_re_spec.tm~>>
    <associate|defn-node-value|<tuple|2.8|13|polkadot_re_spec.tm~>>
    <associate|defn-nodetype|<tuple|2.4|12|polkadot_re_spec.tm~>>
    <associate|defn-offchain-local-storage|<tuple|F.3|59|polkadot_re_spec.tm~>>
    <associate|defn-offchain-persistent-storage|<tuple|F.2|59|polkadot_re_spec.tm~>>
    <associate|defn-path-graph|<tuple|1.2|8|polkadot_re_spec.tm~>>
    <associate|defn-pruned-tree|<tuple|1.12|9|polkadot_re_spec.tm~>>
    <associate|defn-radix-tree|<tuple|1.3|8|polkadot_re_spec.tm~>>
    <associate|defn-runtime|<tuple|<with|mode|<quote|math>|\<bullet\>>|7|polkadot_re_spec.tm~>>
    <associate|defn-sc-len-encoding|<tuple|B.8|42|polkadot_re_spec.tm~>>
    <associate|defn-scale-byte-array|<tuple|B.1|41|polkadot_re_spec.tm~>>
    <associate|defn-scale-list|<tuple|B.5|42|polkadot_re_spec.tm~>>
    <associate|defn-scale-tuple|<tuple|B.2|41|polkadot_re_spec.tm~>>
    <associate|defn-scale-variable-type|<tuple|B.4|41|polkadot_re_spec.tm~>>
    <associate|defn-slot-offset|<tuple|5.9|31|polkadot_re_spec.tm~>>
    <associate|defn-stash-key|<tuple|A.2|?|polkadot_re_spec.tm~>>
    <associate|defn-state-machine|<tuple|1.1|7|polkadot_re_spec.tm~>>
    <associate|defn-stored-value|<tuple|2.1|11|polkadot_re_spec.tm~>>
    <associate|defn-unix-time|<tuple|1.10|9|polkadot_re_spec.tm~>>
    <associate|defn-varrying-data-type|<tuple|B.3|41|polkadot_re_spec.tm~>>
    <associate|defn-vote|<tuple|5.14|35|polkadot_re_spec.tm~>>
    <associate|defn-winning-threshold|<tuple|5.6|30|polkadot_re_spec.tm~>>
    <associate|desc-certifying-keys|<tuple|A.5.5|?|polkadot_re_spec.tm~>>
    <associate|desc-controller-settings|<tuple|A.5.4|?|polkadot_re_spec.tm~>>
    <associate|desc-creating-controller-key|<tuple|A.5.2|?|polkadot_re_spec.tm~>>
    <associate|desc-designating-proxy|<tuple|A.5.3|?|polkadot_re_spec.tm~>>
    <associate|desc-staking-funds|<tuple|A.5.1|?|polkadot_re_spec.tm~>>
    <associate|key-encode-in-trie|<tuple|2.1|12|polkadot_re_spec.tm~>>
    <associate|network-protocol|<tuple|4|25|polkadot_re_spec.tm~>>
    <associate|nota-call-into-runtime|<tuple|3.2|18|polkadot_re_spec.tm~>>
    <associate|nota-re-api-at-state|<tuple|F.1|53|polkadot_re_spec.tm~>>
    <associate|nota-runtime-code-at-state|<tuple|3.1|18|polkadot_re_spec.tm~>>
    <associate|note-slot|<tuple|5.4|29|polkadot_re_spec.tm~>>
    <associate|sect-babe|<tuple|5.1|29|polkadot_re_spec.tm~>>
    <associate|sect-blake2|<tuple|A.2|39|polkadot_re_spec.tm~>>
    <associate|sect-block-body|<tuple|3.3.1.3|22|polkadot_re_spec.tm~>>
    <associate|sect-block-building|<tuple|5.1.7|33|polkadot_re_spec.tm~>>
    <associate|sect-block-finalization|<tuple|5.3|38|polkadot_re_spec.tm~>>
    <associate|sect-block-format|<tuple|3.3.1|21|polkadot_re_spec.tm~>>
    <associate|sect-block-production|<tuple|5.1|29|polkadot_re_spec.tm~>>
    <associate|sect-block-submission|<tuple|3.3.2|23|polkadot_re_spec.tm~>>
    <associate|sect-block-validation|<tuple|3.3.3|23|polkadot_re_spec.tm~>>
    <associate|sect-cryptographic-keys|<tuple|A.5|39|polkadot_re_spec.tm~>>
    <associate|sect-defn-conv|<tuple|1.2|7|polkadot_re_spec.tm~>>
    <associate|sect-encoding|<tuple|B|41|polkadot_re_spec.tm~>>
    <associate|sect-entries-into-runtime|<tuple|3.1|17|polkadot_re_spec.tm~>>
    <associate|sect-epoch-randomness|<tuple|5.1.5|32|polkadot_re_spec.tm~>>
    <associate|sect-extrinsics|<tuple|3.2|19|polkadot_re_spec.tm~>>
    <associate|sect-finality|<tuple|5.2|34|polkadot_re_spec.tm~>>
    <associate|sect-genisis-block|<tuple|C|45|polkadot_re_spec.tm~>>
    <associate|sect-hash-functions|<tuple|A.1|39|polkadot_re_spec.tm~>>
    <associate|sect-int-encoding|<tuple|B.1.1|42|polkadot_re_spec.tm~>>
    <associate|sect-list-of-runtime-entries|<tuple|G.1|67|polkadot_re_spec.tm~>>
    <associate|sect-loading-runtime-code|<tuple|3.1.1|17|polkadot_re_spec.tm~>>
    <associate|sect-merkl-proof|<tuple|2.1.4|14|polkadot_re_spec.tm~>>
    <associate|sect-message-detail|<tuple|E.1|49|polkadot_re_spec.tm~>>
    <associate|sect-msg-block-announce|<tuple|E.1.4|51|polkadot_re_spec.tm~>>
    <associate|sect-msg-block-request|<tuple|E.1.2|50|polkadot_re_spec.tm~>>
    <associate|sect-msg-block-response|<tuple|E.1.3|51|polkadot_re_spec.tm~>>
    <associate|sect-msg-consensus|<tuple|E.1.6|52|polkadot_re_spec.tm~>>
    <associate|sect-msg-status|<tuple|E.1.1|49|polkadot_re_spec.tm~>>
    <associate|sect-msg-transactions|<tuple|E.1.5|51|polkadot_re_spec.tm~>>
    <associate|sect-network-interactions|<tuple|4|25|polkadot_re_spec.tm~>>
    <associate|sect-network-messages|<tuple|E|49|polkadot_re_spec.tm~>>
    <associate|sect-predef-storage-keys|<tuple|D|47|polkadot_re_spec.tm~>>
    <associate|sect-randomness|<tuple|A.3|39|polkadot_re_spec.tm~>>
    <associate|sect-re-api|<tuple|F|53|polkadot_re_spec.tm~>>
    <associate|sect-rte-babeapi-epoch|<tuple|G.2.5|69|polkadot_re_spec.tm~>>
    <associate|sect-rte-grandpa-auth|<tuple|G.2.6|69|polkadot_re_spec.tm~>>
    <associate|sect-rte-hash-and-length|<tuple|G.2.4|68|polkadot_re_spec.tm~>>
    <associate|sect-rte-validate-transaction|<tuple|G.2.7|69|polkadot_re_spec.tm~>>
    <associate|sect-runtime-entries|<tuple|G|67|polkadot_re_spec.tm~>>
    <associate|sect-runtime-return-value|<tuple|3.1.2.3|19|polkadot_re_spec.tm~>>
    <associate|sect-runtime-send-args-to-runtime-enteries|<tuple|3.1.2.2|18|polkadot_re_spec.tm~>>
    <associate|sect-scale-codec|<tuple|B.1|41|polkadot_re_spec.tm~>>
    <associate|sect-state-replication|<tuple|3.3|21|polkadot_re_spec.tm~>>
    <associate|sect-verifying-authorship|<tuple|5.1.6|32|polkadot_re_spec.tm~>>
    <associate|sect-vrf|<tuple|A.4|39|polkadot_re_spec.tm~>>
    <associate|slot-time-cal-tail|<tuple|5.7|30|polkadot_re_spec.tm~>>
    <associate|snippet-runtime-enteries|<tuple|G.1|67|polkadot_re_spec.tm~>>
    <associate|tabl-account-key-schemes|<tuple|A.1|39|polkadot_re_spec.tm~>>
    <associate|tabl-block-attributes|<tuple|E.3|50|polkadot_re_spec.tm~>>
    <associate|tabl-digest-items|<tuple|3.2|22|polkadot_re_spec.tm~>>
    <associate|tabl-inherent-data|<tuple|3.1|21|polkadot_re_spec.tm~>>
    <associate|tabl-message-types|<tuple|E.1|49|polkadot_re_spec.tm~>>
    <associate|tabl-node-role|<tuple|E.2|50|polkadot_re_spec.tm~>>
    <associate|tabl-session-keys|<tuple|A.2|?|polkadot_re_spec.tm~>>
    <associate|tabl-transaction-validity|<tuple|G.2|70|polkadot_re_spec.tm~>>
  </collection>
</references>
...
<\auxiliary>
  <\collection>
    ...
    <\associate|table>
      ...
      network message types.>|<pageref|auto-107>>

      <tuple|normal|<surround|<hidden-binding|<tuple>|E.2>||Node role
      representation in the status message.>|<pageref|auto-110>>
      ...
      requested parts of the data.>|<pageref|auto-112>>
    ...
    <\associate|toc>
      ...
      <with|par-left|<quote|1tab>|A.5.1.<space|2spc>Creating a Controller key
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-93>>

      <with|par-left|<quote|1tab>|A.5.2.<space|2spc>Designating a proxy for
      voting <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-94>>

      <with|par-left|<quote|1tab>|A.5.3.<space|2spc>Controller settings
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-95>>

      <with|par-left|<quote|1tab>|A.5.4.<space|2spc>Certifying keys
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
