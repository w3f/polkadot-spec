...
<\body>
  ...
  <\definition>
    <label|defn-func-inherent-data><name|Inherent-Data >is a hashtable
    (Definition <reference|defn-scale-list>) representing the totality of
    inherent extrinsics included in each block. This data is collected or
    generated by the Polkadot RE and then handed to the Runtime for
    inclusion.
  </definition>
