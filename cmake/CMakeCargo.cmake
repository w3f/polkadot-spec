function(set_cargo_env)
  ...
  set(LIB_BUILD_TYPE ${LIB_BUILD_TYPE} PARENT_SCOPE)
  ...
  set(LIB_COMPILED_FILE "${CMAKE_CURRENT_BINARY_DIR}/${LIB_TARGET}/${LIB_BUILD_TYPE}/${CARGO_NAME}" PARENT_SCOPE)
endfunction()
