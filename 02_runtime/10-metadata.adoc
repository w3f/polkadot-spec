...
====
The **runtime type Id** is a compact integer representing the index of the type
registry entry (<<defn-rtm-registry-entry>>) in stem:[R] of the runtime metadata
structure (<<sect-rtm-structure>>), starting at stem:[0].
