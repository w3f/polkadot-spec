...
fn get_wasm_blob() -> Vec<u8> {
    ...
    // for run_tests.sh -> File::open("build/test/testers/rust-tester/x86_64-unknown-linux-gnu/debug/wbuild/pdre-tester-wasm-blob/pdre_tester_wasm_blob.compact.wasm")
