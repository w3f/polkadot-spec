...
<\body>
  ...
  stored in the transaction queue. It's up to the Polkadot Host to decide the
  validity of those entries and mostly serve as unverified metadata.
  ...
  <\definition>
    ...
    the inherent identifier and its value, representing the totality of
    inherent extrinsics included in each block. The entries of this hash
    ...
    <reference|algo-build-block>. The identifiers are 8-byte values.
  </definition>
...
<\references>
  <\collection>
    ...
    <associate|sect-inherents|<tuple|3.2.3.1|?>>
