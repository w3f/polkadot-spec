...
v} + 2 \times T$ {\tmstrong{or}} {\tmname{Completable}}($r$)){\END}}}

{\state{$L \leftarrow${\tmname{Received-as-Final()}} {\tmstrong{or}}
...
v} + 4 \times T${\tmstrong{ or }}{\tmname{Completable}}($r$)))}}

{\state{{\tmname{Broadcast($M_v^{r, \tmop{pc}}$(Best-Final-Candidate($r$))}}}}
...
{\algorithm{\label{alg-completable-round}{\tmname{Completable}}($r$)}{{\algorithmic{{\state{$E
\leftarrow${\tmname{Best-Final-Candidate}}($r$)}}

{\state{{\IF{$E \neq \phi$}}}}

{\state{{\RETURN{{\tmname{True}}{\END}}}}}

{\state{{\ELSEIF{$r$ {\tmstrong{is}} unfinalizable}}}}

{\state{{\RETURN{{\tmname{True}}{\END}}}}}

{\state{{\ELSE{\ }}}}

{\state{{\RETURN{{\tmname{False{\END}}}}}}}}}}}

{\algorithm{{\tmname{FinalizeRound}}($r$)}{{\algorithmic{{\state{$L
