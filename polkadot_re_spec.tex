...
(see Section \ref{sect-storage-api}) to insert a new Wasm blob into runtime
...
\ }{\label{snippet-runtime-enteries}Snippet to export entries into tho Wasm
runtime module}
...
format described in Section \ref{sect-runtime-abi} containing the following
data:
...
2\tmverbatim{}\quad Verify $H_{p (B)} \in \tmop{Blockchain}$.

3\quad State-Changes = Runtime.{\tmname{Execute-Block$(B)$}}

\tmverbatim{}4\quad{\tmname{Update-World-State}}(S\tmverbatim{}tate-Changes)\tmverbatim{}}}
