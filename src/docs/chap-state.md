...
:::note Bomb Limit is set much higher than the expected maximum code size, but may be adjusted upwards in the future. When adjusting upwards, nodes should be updated before performing a runtime upgrade to a blob with larger compressed size.
:::
