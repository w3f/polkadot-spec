...
(gdb "gdb -i=mi --cd ../build/bin/usr/local/bin/  --args ./rust_tester state-trie trie-root --keys-in-hex --state-file \"/home/klaymen/doc/code/polkadot-re-tests/test/fixtures/10000-node-trie.yaml\"")
