...
image::01_host/05_consensus/assets/authority_set_scheduled_change_chart.png["Scheduled Change Chart"]

.Applying a forced change
image::01_host/05_consensus/assets/authority_set_forced_change_chart.png["Forced Change Chart"]
