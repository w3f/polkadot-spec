...
(<<sect-light-remote-read-request>>). If the client indicated to skip the value
and instead use the hash of the value, this proof is generated as a hashed
subvalue (<<defn-hashed-subvalue>>).
