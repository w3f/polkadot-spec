...
where stem:[k] indicates the kind of the certificate, respectively the value of
_0_ proves the availability core assignment
(<<defn-availability-core-vrf-assignment>>), followed by the sample number
stem:[s], and the value of _1_ proves the delayed availability core assignment
