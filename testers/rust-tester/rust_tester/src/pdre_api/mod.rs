    ...
    if let Some(func) = subcmd_matches.value_of("function") {
        ...
        match func {
            ...
            "ext_trie_blake2_256_ordered_root_version_1" => {
                trie::ext_trie_blake2_256_ordered_root_version_1(input)
            }
