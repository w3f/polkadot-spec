...
\begin{definition}
  ...
  \[
  C_{receipt}(PoV_B) := (id_p, h_b({B_{^{relay}_{parent}}}), Head_p(B), id_{C}, Sig^{Collator}_{SR25519}, h_b({PoV_B}), Blake2b(CC(PoV_B)))
  \]
...
\begin{definition}
  ...
  \begin{itemize}
    ...
    \item $\mathbb{U}(R_\rho)$: A varying datatype (Def. \ref{defn-scale-codec})
