...
\begin{itemize}
  ...
  invalid PoV block, preventing any new PoV blocks from being received. The
  amount of time for blacklisting is unspecified.
  \item \textsc{AnnounceMisbehaviorOf}: Announces the misbehavior of the validator who claimed a valid statement of invalid PoV block as described in algorithm \todo{@fabio}.
  \item \textsc{Propagate} Sends the statement to the connected peers.
\end{itemize}
