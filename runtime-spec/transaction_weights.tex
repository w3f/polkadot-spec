...
Section \ref{sect:examples-runtime-analysis} walks through two practical examples of Runtime function analysis.

Not every possible benchmarking outcome can be invoked by varying input parameters \syed{to}{of} the Runtime function. In some 
