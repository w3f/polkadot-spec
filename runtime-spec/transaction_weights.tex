...
It then proceeds the search all those entries for the specified registrar index.
If the field can be found, the corresponding value is updated to the value
