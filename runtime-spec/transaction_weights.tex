...
proportional to each others execution time and "heaviness". For example, if
Extrinsic A takes three times longer to execute than Extrinsic B, then Extrinsic
A should have three times the amount of weight than Extrinsic B.
\newline
