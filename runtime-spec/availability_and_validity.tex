...
The Figures \ref{diag-anv-overall-part1}, \ref{diag-anv-overall-part2} and \ref{diag-anv-overall-part3} demonstrates the overall process of assuring availability and validity in Polkadot.

\begin{figure}[h!]
\label{diag-anv-overall-part1}
\begin{plantuml}
%%    
@startuml
start
...
@enduml
\end{plantuml}
\caption{Part 1 of the overall process to acheive availability and validity in Polkadot}
\end{figure}

\newpage
\begin{figure}[h!]
\label{diag-anv-overall-part2}
\begin{plantuml}
@startuml
start
...
@enduml
\end{plantuml}
\caption{Part 2 of the overall process to acheive availability and validity in Polkadot}
\end{figure}

\begin{figure}[h!]
\label{diag-anv-overall-part3}
\begin{plantuml}
@startuml
start
...
@enduml
\end{plantuml}
\caption{Part 3 of the overall process to acheive availability and validity in Polkadot}
\end{figure}
