...
(*) --> "Parachain Collator C_ρ Generates B and PoV"
    --> "C_ρ sends PoV_B to ρ's validator V_ρ"

    --> "V_{rho} runs Rho's runtime on PoV"
    if "PoV is valid" then
    -->[true] if  "V_{rho} have seen the CandidateReceipt for PoV" then
    ...
    -->[false] "Broadcast message of invalidity for PoV"
    end if
