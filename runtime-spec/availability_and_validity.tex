...
Validators first validate the candidate received from Collators as described in
Algorithm \ref{algo-primary-validation}. It does the same thing with candidates
received from other peers. It's note worthy that validators do not dictate which
candidates are priorities for inclusion. Each Validator decides for itself - on whatever
metric - which \textit{valid} candidate to include
...
\begin{definition}
  ...
  \[
  (Stmt, id_{\mathbb{V}}, Sig_{SR25519})
  \]
