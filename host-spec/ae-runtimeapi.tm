...
<\body>
  ...
  <\itemize-dot>
    <item>A SCALE-encoded <verbatim|Option> as defined in Definition
    <reference|defn-option-type> containing an array of varying sizes
    indicating the seed.
  </itemize-dot>
  ...
  <\itemize-dot>
    ...
    where <math|k> is an array of varying sizes containg the raw public key
