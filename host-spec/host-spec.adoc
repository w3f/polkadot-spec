...
Fabio Lama <fabio@web3.foudation>; Florian Franzen <florian@web3.foundation>; Syed Hosseini <syed@web3.foundation>
...
[#chap-host-api]
== Polkadot Host API
include::c08_host-api/intro.adoc[]
include::c08_host-api/storage.adoc[]
include::c08_host-api/child_storage.adoc[]
include::c08_host-api/crypto.adoc[]
include::c08_host-api/hashing.adoc[]
include::c08_host-api/offchain.adoc[]
include::c08_host-api/trie.adoc[]
include::c08_host-api/misc.adoc[]
include::c08_host-api/allocator.adoc[]
include::c08_host-api/logging.adoc[]
