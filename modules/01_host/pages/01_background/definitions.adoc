...
blockchain (xref:05_consensus/finality.adoc#sect-finality[Sect.]).
****
...
finalized blocks (xref:05_consensus/block_finalization.adoc#defn-finalized-block[Def.]). By *pruning*, we refer to the
...
xref:01_background/definitions.adoc#defn-chain-subchain[Def.] gives the means to highlight various branches of the
block tree.
****
...
"Head"(C_2)] (xref:05_consensus/block_production.adoc#defn-block-time[Def.]). We define the stem:[sf "Longest-Chain"(BT)]
...
(xref:05_consensus/block_production.adoc#defn-block-time[Def.]). stem:[sf "Deepest-Leaf"(BT)] returns the head of stem:[sf
