...
xref:04_networking/fundamentals.adoc#sect-networking-external-docs[Sect.]
...
over _mplex_. xref:04_networking/fundamentals.adoc#sect-protocols-substreams[Sect.] describes the subprotocol in more
detail.
...
xref:04_networking/messages.adoc#sect-network-messages[Sect.].
...
the node’s _PeerId_ as defined in xref:04_networking/fundamentals.adoc#defn-peer-id[Def.] is derived from its public
key. _PeerId_ is used to identify each node when they are discovered in the
course of the discovery mechanism described in xref:04_networking/fundamentals.adoc#sect-discovery-mechanism[Sect.].
...
as described in xref:04_networking/fundamentals.adoc#sect-protocols-substreams[Sect.].
...
xref:04_networking/fundamentals.adoc#sect-protocols-substreams[Sect.] describes the usage of each type in more detail:
...
See xref:04_networking/fundamentals.adoc#sect-protocols-substreams[Sect.] for more information.
...
xref:04_networking/fundamentals.adoc#sect-encryption-layer[Sect.].
...
xref:04_networking/fundamentals.adoc#sect-connection-establishment[Sect.].
...
+
The messages are specified in xref:04_networking/messages.adoc#sect-msg-block-announce[Sect.].
...
+
The messages are specified in xref:04_networking/messages.adoc#sect-msg-block-request[Sect.].
...
+
The messages are specified in xref:04_networking/messages.adoc#sect-msg-transactions[Sect.].
...
+
The messages are specified in xref:04_networking/messages.adoc#sect-msg-grandpa[Sect.].
+
...
BEEFY statements, as described in xref:05_consensus/bridge_design.adoc#sect-grandpa-beefy[Sect.], to connected peers.
This is a _Notification_ substream.
+
The messages are specified in xref:04_networking/messages.adoc#sect-msg-grandpa-beefy[Sect.].
