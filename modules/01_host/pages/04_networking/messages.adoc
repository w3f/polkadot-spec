...
described in xref:04_networking/messages.adoc#defn-block-announce-handshake[Def.].
...
established, all `BlockAnounce` messages (xref:04_networking/messages.adoc#defn-block-announce[Def.]) created by
...
(xref:02_encoding.adoc#defn-varrying-data-type[Def.]) of the following format:
+
[cols="1,4"]
|===
|Id |Description
...
|xref:03_transition/state_replication.adoc#defn-block-header[Def.]

|repeated `bytes`
|3
|Block body (optional)
|xref:03_transition/state_replication.adoc#defn-block-body[Def.]
...
|xref:05_consensus/finality.adoc#defn-grandpa-justification[Def.]
...
Transactions (xref:03_transition/extrinsics.adoc#sect-extrinsics[Sect.]) are sent directly to peers with which the
Polkadot Host has an open transaction substream (xref:04_networking/messages.adoc#defn-transactions-message[Def.]).
...
xref:03_transition/extrinsics.adoc#sect-extrinsics[Sect.].
...
the creation and distributing these messages is described in xref:05_consensus/finality.adoc#sect-finality[Sect.].
...
(xref:02_encoding.adoc#defn-varrying-data-type[Def.]) which identifies the message type that is cast by
...
* stem:[V_m] is defined in xref:04_networking/messages.adoc#defn-grandpa-vote-msg[Def.].
* stem:[C_m] is defined in xref:04_networking/messages.adoc#defn-grandpa-commit-msg[Def.].
* stem:[N_m] is defined in xref:04_networking/messages.adoc#defn-grandpa-neighbor-msg[Def.].
* stem:[R_m] is defined in xref:04_networking/messages.adoc#defn-grandpa-catchup-request-msg[Def.].
* stem:[U_M] is defined in xref:04_networking/messages.adoc#defn-grandpa-catchup-response-msg[Def.].
****
...
(xref:05_consensus/finality.adoc#defn-voting-rounds[Def.]).
* stem:["id"_(bbb V)] is an unsigned 64-bit integer indicating the authority Set Id (xref:05_consensus/common.adoc#defn-authority-list[Def.]).
* stem:["Sig"_(v_i)^(r,"stage")] is a 512-bit byte array containing the
signature of the authority (xref:05_consensus/finality.adoc#defn-sign-round-vote[Def.]).
...
* stem:[V_v^(r,"stage")(B)] is the GRANDPA vote for block stem:[B] (xref:05_consensus/finality.adoc#defn-voting-rounds[Def.]).

This message is the sub-component of the GRANDPA gossip message
(xref:04_networking/messages.adoc#defn-gossip-message[Def.]) of type Id 0.
****
...
* stem:[V_(v_i)^(r,pc)] is a 256-bit byte array containing the pre-commit vote of authority stem:[v_i] (xref:05_consensus/finality.adoc#defn-voting-rounds[Def.]).
* stem:["Sig"_(v_i)^(r,pc)] is a 512-bit byte array containing the pre-commit
signature of authority stem:[v_i] (xref:05_consensus/finality.adoc#defn-sign-round-vote[Def.]).
...
* stem:[r] is an unsigned 64-bit integer indicating the round number (xref:05_consensus/finality.adoc#defn-voting-rounds[Def.]).
* stem:[id_(bbb V)] is the authority set Id (xref:05_consensus/common.adoc#defn-authority-list[Def.]).
* stem:[V_v^r(B)] is a 256-bit array containing the GRANDPA vote for block
stem:[B] (xref:05_consensus/finality.adoc#defn-vote[Def.]).
...
(xref:04_networking/messages.adoc#defn-grandpa-justifications-compact[Def.]).

This message is the sub-component of the GRANDPA gossip message
(xref:04_networking/messages.adoc#defn-gossip-message[Def.]) of type Id _1_.
****
...
Id (xref:05_consensus/common.adoc#defn-authority-list[Def.]).
* stem:[H_i(B_("last"))] is an unsigned 32-bit integer indicating the block number of the last finalized block stem:[B_("last")].

This message is the sub-component of the GRANDPA gossip message
(xref:04_networking/messages.adoc#defn-gossip-message[Def.]) of type Id _2_.
****
...
messages (xref:04_networking/messages.adoc#defn-grandpa-neighbor-msg[Def.]) reveal the round number for the last
...
the catch-up procedure explained in xref:05_consensus/block_finalization.adoc#sect-grandpa-catchup[Sect.]).
...
This message is the sub-component of the GRANDPA Gossip message
(xref:04_networking/messages.adoc#defn-gossip-message[Def.]) of type Id _3_.
****
...
round stem:[r] (xref:05_consensus/finality.adoc#defn-voting-rounds[Def.]). stem:[B'] is the highest ancestor of
all blocks voted on in the arrays of justifications stem:[J_(0,...n)^(r,"pv")(B)]
and stem:[J_(0,...m)^(r,"pc")(B)] (xref:05_consensus/finality.adoc#defn-grandpa-justification[Def.]) with the
exception of the equivocatory votes.

This message is the sub-component of the GRANDPA Gossip message
(xref:04_networking/messages.adoc#defn-gossip-message[Def.]) of type Id _4_.
****
...
(xref:05_consensus/bridge_design.adoc#sect-grandpa-beefy[Sect.]). Those messages are sent over the `/paritytech/beefy/1`
substream.
...
latest, finalized block.
* stem:["id"_(bbb V)] is the current authority set Id (xref:05_consensus/finality.adoc#defn-authority-set-id[Def.]).
****
...
* stem:[C] is the BEEFY commitment (xref:04_networking/messages.adoc#defn-grandpa-beefy-commitment[Def.]).
...
(xref:05_consensus/finality.adoc#defn-authority-set-id[Def.]) in stem:[C]. Individual items are of the type
_Option_ (xref:02_encoding.adoc#defn-option-type[Def.]) which can contain a signature of a validator
...
validator, then the _Option_ variant is _None_ inserted (xref:02_encoding.adoc#defn-option-type[Def.]).
...
BEEFY commitment (xref:04_networking/messages.adoc#defn-grandpa-beefy-signed-commitment[Def.]). Instead of
...
BEEFY commitment (xref:04_networking/messages.adoc#defn-grandpa-beefy-signed-commitment[Def.]).
****
