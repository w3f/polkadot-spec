...
(Definition xref:intro.adoc#defn-runtime-pointer-size[Def.]) to the SCALE-encoded return data.
====

See xref:03_transition/runtime_interaction.adoc#sect-code-executor[Sect.] for more information about the behaviour of the Wasm Runtime. Also note that any state changes created by calling any of the Runtime functions are not necessarily to be persisted after the call is ended. See xref:03_transition/runtime_interaction.adoc#sect-handling-runtime-state-update[Sect.] for more information.
